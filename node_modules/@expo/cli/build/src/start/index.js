#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\User\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.533-universal\\out\\buildHook\\index.js').default({tool: 'react-native', checkSum: '20323bba8bf2bbcc971971AxwBVkxTClhWUVZWVQVbVQgLAgAB', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/User/.cursor/extensions/wallabyjs.console-ninja-1.0.533-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'react-native', checkSum: '20323bba8bf2bbcc971971AxwBVkxTClhWUVZWVQVbVQgLAgAB', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
