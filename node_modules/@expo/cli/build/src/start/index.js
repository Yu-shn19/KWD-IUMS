#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\User\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.540-universal\\out\\buildHook\\index.js').default({tool: 'react-native', checkSum: '2075ec333513e08680591bBxtXVx0BAQ8HAVEHAFQIU1ddB1ID', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/User/.cursor/extensions/wallabyjs.console-ninja-1.0.540-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'react-native', checkSum: '2075ec333513e08680591bBxtXVx0BAQ8HAVEHAFQIU1ddB1ID', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
